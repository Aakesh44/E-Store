  ...
  "../../node_modules/.pnpm/fs-extra@10.0.0/node_modules/fs-extra/lib/util/utimes.js"(exports2, module2) {
    ...
    function utimesMillis(path7, atime, mtime2, callback) {
      fs5.open(path7, "r+", (err, fd) => {
        if (err)
          return callback(err);
        fs5.futimes(fd, atime, mtime2, (futimesErr) => {
    ...
    function utimesMillisSync(path7, atime, mtime2) {
      ...
      fs5.futimesSync(fd, atime, mtime2);
...
var require_remove = __commonJS({
  "../../node_modules/.pnpm/fs-extra@10.0.0/node_modules/fs-extra/lib/remove/index.js"(exports2, module2) {
    ...
    function remove2(path7, callback) {
      if (fs5.rm)
        return fs5.rm(path7, { recursive: true, force: true }, callback);
      rimraf(path7, callback);
    }
    function removeSync(path7) {
      if (fs5.rmSync)
        return fs5.rmSync(path7, { recursive: true, force: true });
      rimraf.sync(path7);
    }
    module2.exports = {
      remove: u(remove2),
...
var require_multistream = __commonJS({
  "../../node_modules/.pnpm/multistream@2.1.1/node_modules/multistream/index.js"(exports2, module2) {
    ...
    function MultiStream(streams, opts) {
      var self = this;
      if (!(self instanceof MultiStream))
      ...
      if (typeof streams === "function") {
        ...
        self._queue.forEach(function(stream2) {
          if (typeof stream2 !== "function")
            self._attachErrorListener(stream2);
        });
      }
      self._next();
    }
    ...
    MultiStream.prototype._next = function() {
      ...
      if (typeof self._queue === "function") {
        self._queue(function(err, stream3) {
          if (err)
            return self.destroy(err);
          stream3 = self._toStreams2(stream3);
          self._attachErrorListener(stream3);
          self._gotNextStream(stream3);
        });
      } else {
        var stream2 = self._queue.shift();
        if (typeof stream2 === "function") {
          stream2 = self._toStreams2(stream2());
          self._attachErrorListener(stream2);
        }
        self._gotNextStream(stream2);
      }
    };
...
var require_loader = __commonJS({
  "../../node_modules/.pnpm/js-yaml@3.13.1/node_modules/js-yaml/lib/js-yaml/loader.js"(exports2, module2) {
    ...
    function composeNode(state, parentIndent, nodeContext, allowToSeek, allowCompact) {
      var allowBlockStyles, allowBlockScalars, allowBlockCollections, indentStatus = 1, atNewLine = false, hasContent = false, 